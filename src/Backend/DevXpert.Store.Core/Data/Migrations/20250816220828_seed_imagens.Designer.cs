...
namespace DevXpert.Store.Core.data.migrations
{
    ...
    [Migration("20250816220828_seed_imagens")]
    partial class seed_imagens
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DevXpert.Store.Core.Business.Models.Produto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Estoque = 100,
                            Imagem = "f5dd84d8-ccda-43e8-96cf-be0ccff0de3b_computador.jpg",
                            Nome = "Computador",
                            Preco = 5000m,
                        ...
                        new
                        {
                            ...
                            Estoque = 20,
                            Imagem = "5fa99536-a7c8-403d-a0a0-373f30773054_mouse.jpg",
                            Nome = "Mouse",
                            Preco = 60m,
                            VendedorId = new Guid("f96e5735-7f8a-49a7-8fe1-64304e70257d")
                        },
                        new
                        {
                            ...
                            Estoque = 15,
                            Imagem = "26361398-ab18-4efd-879f-1f0ad1bb6d9e_teclado.jpg",
                            Nome = "Teclado",
                            Preco = 100m,
                            VendedorId = new Guid("f96e5735-7f8a-49a7-8fe1-64304e70257d")
                        },
                        new
                        {
                            ...
                            Estoque = 28,
                            Imagem = "6fa552cd-bdbf-4f4d-b298-987c3a140275_monitor_27.jpg",
                            Nome = "Monitor",
                            Preco = 780m,
                            VendedorId = new Guid("f96e5735-7f8a-49a7-8fe1-64304e70257d")
                        });
